...
- **CLAUDE.md §5 and §6 and CONTRIBUTING.md** — content-side accessibility: heading hierarchy in markdown, link text discipline, bilingual screen-reader copy, translationKey pairing.
